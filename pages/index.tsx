          ...
          <section className='flex flex-col w-full px-8 md:flex-row min-h-[50vh]'>
            ...
            <div className='w-full md:order-2'>
              ...
              <div className='text-lg tracking-tight prose-sm text-gray-400'>
                ...
                <p>
                  We have 10,000 1st generation rescued Trauma Llamas that are in need of
                  a good home. These Llamas have seen rough times traveling long and far
                  so please consider adopting one of these Llamas so we can go out and
                  save more as our sanctuary is at capacity.
                </p>
            ...
            <div className='w-full md:order-2'>
              ...
              <div className='mb-6 text-lg tracking-tight prose-sm text-gray-400'>
                <p>
                  ...
                  the world. We’ll do this by making donations to _ and _ in a total
                  amount of $25,000. Additionally as a way to help other members of the
                  community develop and launch their own NFT’s a community vote will be
                  held, with the top 3 projects receiving a $10,000 fund to help them
                  become a reality.
                </p>
                <p>
                  If you’d like to learn more about the rest of our plans then please
                  click to view our roadmap.
                </p>
              </div>
              <div className='grid grid-cols-2 gap-4 mb-6 md:grid-cols-1 lg:grid-cols-3'>
                <Link href='/roadmap'>
